...
import BgImage from '@/assets/roomHero.png';


export const RoomHero: React.FC = () => {
    return (
        <div
            ...
            <div className='container mx-auto px-4 flex-grow flex flex-col items-center justify-center relative z-10'>
                ...
                <div className='text-center w-full max-w-3xl px-4 py-8'>
                    <h1 className='text-2xl md:text-3xl font-bold mb-4 text-white'>
                        ...
                        <Link to="/contact" className='hover:text-amber-400 transition-colors'>Room Details</Link>
                    </h1>
                    <p className='text-xl md:text-2xl text-white font-medium'>
                        <Link to="/" className='hover:text-amber-400 transition-colors'>Home</Link>
                        <span className='mx-2'>/</span>
                        <Link to="/contact" className='hover:text-amber-400 transition-colors'>Rooms</Link>
